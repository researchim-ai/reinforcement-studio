...
ALGORITHM_CATALOG = [
    ...
    },
    {
        ...
        "description": "Наш собственный алгоритм: архитектура UniZero (causal Transformer + RoPE + "
                        ...
                        "consistency, PER + reanalyze), плюс streaming replay, context-aware EMA bootstrap, "
                        "closed-loop overshooting и адаптивный бюджет поиска. Discrete и continuous.",
        "hyperparams": [
            {"key": "learning_rate", "label": "Learning rate", "type": "float", "default": 2e-4, "min": 1e-6, "max": 1e-1},
            {
            ...
            {"key": "num_simulations_initial", "label": "Симуляций в начале обучения", "type": "int", "default": 8, "min": 2, "max": 256},
            {"key": "search_ramp_steps", "label": "Шагов до полного бюджета поиска", "type": "int", "default": 100_000, "min": 1_000, "max": 10_000_000},
            {"key": "search_model_error_low", "label": "Ошибка модели для полного бюджета поиска", "type": "float", "default": 0.02, "min": 0.0, "max": 10.0},
            {"key": "search_model_error_high", "label": "Ошибка модели для минимального бюджета поиска", "type": "float", "default": 0.3, "min": 0.001, "max": 20.0},
            {"key": "search_model_error_ema_decay", "label": "Сглаживание ошибки модели", "type": "float", "default": 0.99, "min": 0.0, "max": 0.9999},
            {"key": "num_top_actions", "label": "Корневых кандидатов в Sequential Halving (m)", "type": "int", "default": 8, "min": 2, "max": 64},
            {"key": "c_visit", "label": "Sigma-transform: c_visit", "type": "float", "default": 50.0, "min": 1.0, "max": 200.0},
            {"key": "c_scale", "label": "Sigma-transform: c_scale", "type": "float", "default": 0.1, "min": 0.01, "max": 5.0},
            {"key": "policy_target_temperature", "label": "Температура шума Гумбеля в корне", "type": "float", "default": 1.0, "min": 0.01, "max": 10.0},
            ...
            {"key": "temperature_anneal_steps", "label": "Шагов затухания exploration", "type": "int", "default": 100_000, "min": 1_000, "max": 10_000_000},
            {"key": "value_minmax_delta", "label": "Мин. эпсилон нормализации Q (MinMaxStats)", "type": "float", "default": 0.01, "min": 1e-4, "max": 1.0},
            {"key": "value_support_size", "label": "Категориальный support value/reward-головы (±N бинов)", "type": "int", "default": 300, "min": 5, "max": 1000},
            ...
            {"key": "closed_loop_loss_coef", "label": "Вес closed-loop overshooting", "type": "float", "default": 0.5, "min": 0.0, "max": 10.0},
            {"key": "closed_loop_horizon", "label": "Горизонт closed-loop unroll", "type": "int", "default": 3, "min": 1, "max": 30},
            {"key": "closed_loop_batch_fraction", "label": "Доля batch для closed-loop", "type": "float", "default": 0.25, "min": 0.0, "max": 1.0},
            {
            ...
            {"key": "train_steps_per_iter", "label": "Градиентных шагов за vector-итерацию обучения", "type": "int", "default": 2, "min": 1, "max": 100},
            {
            ...
            {"key": "min_priority", "label": "Минимальный приоритет перехода", "type": "float", "default": 1e-6, "min": 1e-8, "max": 1.0},
            {"key": "replay_recent_fraction", "label": "Доля свежих активных переходов в replay", "type": "float", "default": 0.5, "min": 0.0, "max": 1.0},
            {"key": "replay_recent_window", "label": "Размер свежего окна на активную среду", "type": "int", "default": 512, "min": 1, "max": 100_000},
            {"key": "reanalyze_freq", "label": "Реальных шагов между reanalyze-проходами", "type": "int", "default": 200, "min": 1, "max": 100_000},
            {"key": "reanalyze_batch_size", "label": "Переходов, обновляемых за один reanalyze-проход (0 = выключить)", "type": "int", "default": 64, "min": 0, "max": 1024},
            {
            ...
            {"key": "reanalyze_value_mix", "label": "Доля свежего search value в TD-цели", "type": "float", "default": 0.25, "min": 0.0, "max": 1.0},
            {
