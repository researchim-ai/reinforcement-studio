...
class TicTacToe(BoardGame):
    ...
    def step(self, action: int) -> tuple[np.ndarray, bool, int | None]:
        ...
        # `current_player` always flips, even on the terminal move: this
        # keeps encode()/value conventions consistent (see games/base.py) —
        # a finished game is "viewed" from the loser's/non-mover's side.
